...
class CreatePhp5Project
{
	public static function Run($arg = null)
	{
		...
		$langs = array_slice(func_get_args(), 3);
		...
		if ( file_exists($PHPDIR) )
		{
			...
			if ( file_exists($HOME) )
			{
				...
				$LANGUAGESAVAILABLE = self::createStaticDirectories($HOME, $HTTPDOCS, $TEMPLATE, $langs);

				self::createLibDirectories($HOME, $PROJECT, $PROJECT_FILE, $TEMPLATE);

				self::createDataFiles($HOME, $PROJECT, $PROJECT_FILE, $HTTPDOCS, $DATADIR, $PHPDIR, $XMLNUKE, $TEMPLATE, $LANGUAGESAVAILABLE);

				self::createCodeGenXFiles($HOME, $TEMPLATE, $XMLNUKE, $PROJECT);

				self::linkingAndCreateGitIgnore($HOME, $PHPDIR, $XMLNUKE, $HTTPDOCS);
	...
	protected static function createStaticDirectories($HOME, $HTTPDOCS, $TEMPLATE, $langs)
	{
		...
		{
			$langsAvail[] = "'" . $lang . "' => '" . $lang . "'";

			@mkdir( "$HOME/data/xml/" . $lang );
			copy( "$TEMPLATE/project/index.xsl.template", "$HOME/data/xsl/index." . $lang . ".xsl" );
			copy( "$TEMPLATE/project/page.xsl.template", "$HOME/data/xsl/page." . $lang . ".xsl" );
			copy( "$TEMPLATE/project/index.xml.template", "$HOME/data/xml/" . $lang . "/index." . $lang . ".xml" );
			copy( "$TEMPLATE/project/home.xml.template", "$HOME/data/xml/" . $lang . "/home." . $lang . ".xml" );
			copy( "$TEMPLATE/project/notfound.xml.template", "$HOME/data/xml/" . $lang . "/notfound." . $lang . ".xml" );

			CreatePhp5Project::writeToFile( "$HOME/data/xml/" . $lang . "/index.php.btree", "xmlnuke\n+home." . $lang . ".xml" );
		}
	...
	protected static function createLibDirectories($HOME, $PROJECT, $PROJECT_FILE, $TEMPLATE)
	{
	...
	protected static function createDataFiles($HOME, $PROJECT, $PROJECT_FILE, $HTTPDOCS, $DATADIR, $PHPDIR, $XMLNUKE, $TEMPLATE, $LANGUAGESAVAILABLE)
	{
		# Anydataset Files
		$aux = "";
	...
	protected static function createCodeGenXFiles($HOME, $TEMPLATE, $XMLNUKE, $PROJECT)
	{
		# CodeGenX Generators
		@mkdir( "$HOME/codegenx" );
	...
	protected static function linkingAndCreateGitIgnore($HOME, $PHPDIR, $XMLNUKE, $HTTPDOCS)
	{
