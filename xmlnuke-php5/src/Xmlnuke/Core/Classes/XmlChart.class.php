...
class  XmlChart extends XmlnukeDocumentObject
{
	...
	*/
	...
	public function addSeries($fieldname, $name, $bordercolor, $fillcolor=null, $type = null, $seriesNotes = null)
	{
		...
		elseif (is_null($type))
		{
			throw new InvalidArgumentException("Type is required when default chart type is not Mixed");
		}
		else
		{
			$serie->type = $type;
		...
		{
			throw new InvalidArgumentException("You should pass an SeriesNotesType object");
		}
		else
		{
