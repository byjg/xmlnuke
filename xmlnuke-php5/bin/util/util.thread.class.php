 ...
 * 
 * This file was changed based on the forum existing at the author's web site;
...
class Thread {
    ...
    public static function runnableOk( $_runnable ) {
    	if (is_array($_runnable))
	    	return (method_exists(get_class($_runnable[0]), $_runnable[1]) && is_callable($_runnable) );
	    else
