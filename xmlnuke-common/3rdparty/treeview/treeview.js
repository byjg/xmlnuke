...
/*******************************************************************************
 * Name : toggle Parameters : node , DOM element (<a> tag) Description :
 * Description, collapse or unfold a branch Author : Jean-Michel Garnier / D.D.
 * de Kerf
 ******************************************************************************/
...
Description : Select the current node
...
function toggleSelect(node) {
	...
	for ( var i = 0, link; link = tagLinks[i]; i++ ) 
	{
		if (link.className == "leafsel")
		{
			link.className = 'leaf';
		}
	}
	node.className = "leafsel";
}
...
/*******************************************************************************
 * Name : stringExtract Parameters : - st String input string, contains n
 * separators - position int, from 0 to n, position of the token wanted -
 * separator char, separator between token
 * 
 * Return : the token at the position wanted if it exists Description :
 * Equivalent to class java.util.StringTokenizer Example -> stringExtract("A; B;
 * C", 0, ";") = "A" Author : Jean-Michel Garnier
 ******************************************************************************/
