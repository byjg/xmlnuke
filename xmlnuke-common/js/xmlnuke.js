...
$(document).ready(function (){
	var x =
		"<div id='lding_div' style='background:#fff; width: 100%; position: absolute; height:37px; top: 0px; left: 0px; border-bottom: 1px solid #233a79; opacity: 0.65; padding-top: 5px; filter:alpha(opacity=65); '>" +
