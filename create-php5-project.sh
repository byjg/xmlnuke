	...
	then
		...
		then
			...
			do
				...
				cp "$XMLNUKE/xmlnuke-data/sites/index.xsl.template" "$HOME/data/xsl/index.$3.xsl"
				cp "$XMLNUKE/xmlnuke-data/sites/page.xsl.template" "$HOME/data/xsl/page.$3.xsl"
				cp "$XMLNUKE/xmlnuke-data/sites/index.xml.template" "$HOME/data/xml/$3/index.$3.xml"
				cp "$XMLNUKE/xmlnuke-data/sites/home.xml.template" "$HOME/data/xml/$3/home.$3.xml"
				cp "$XMLNUKE/xmlnuke-data/sites/notfound.xml.template" "$HOME/data/xml/$3/notfound.$3.xml"
			...
			cp "$XMLNUKE/xmlnuke-data/sites/module.php.template" "$HOME/lib/modules/home.class.php"
