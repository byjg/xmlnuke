         ...
         <body>
            <center>
               <table border="0" width="750" cellpadding="0" cellspacing="1">
                  <tr>
                     <td align="right">
                         <a><xsl:attribute name="href">engine:xmlnuke?xml=<xsl:value-of select="$xml" />&amp;xsl=xmlword</xsl:attribute>Save as Word Document</a> | <a href="module:search">Find</a> | [param:LANGUAGESELECTOR]
                     </td>
                  </tr>
               </table>
