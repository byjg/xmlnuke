   ...
   <xsl:template match="/">
      <HTML>
	    ...
	    <xmlnuke-htmlheader />
         ...
         <BODY>
            <div Align="right">
               <a href="engine:xmlnuke?xml=index&amp;xsl=index">Site Map</a> | <a href="#" onclick="javascript:window.open('[param:script_name]?=[param:xml]&amp;xsl=preview&amp;lang=[param:lang]&amp;module=[param:module]','','toolbar=yes,location=no,status=no,menubar=yes,scrollbars=yes,resizable=no,width=660,height=440')">Prepare to Print</a> | [param:languageselector]
				</div>
