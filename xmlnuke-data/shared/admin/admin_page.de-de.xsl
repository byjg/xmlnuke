...
<body>
	...
	<div id="header">
	 <h1>Systemsteuerung - <xsl:value-of select="page/meta/title" /></h1>
	 <div id="menu">
	  <ul id="nav">
	   <li><a href="admin:controlpanel">Start</a></li>
	   ...
	   <li><a href="admin:controlpanel?logout=true">Abmelden</a></li>
	  </ul>
	 </div>
	</div>
