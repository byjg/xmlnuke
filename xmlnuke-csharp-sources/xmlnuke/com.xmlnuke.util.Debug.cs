...
namespace com.xmlnuke.util
{
    public class Debug
    {
        ...
        protected const string sSource = "Xmlnuke";
        protected const string sLog = "Application";
        ...
        {
            Debug.LogText(text, EventLogEntryType.Information);
        }
         ...
         * @return void
         */
        public static void LogText(string text, EventLogEntryType entryType)
        {
            if (!EventLog.SourceExists(sSource))
                EventLog.CreateEventSource(sSource, sLog);

            EventLog.WriteEntry(sSource, text, entryType);
        }
    }
}